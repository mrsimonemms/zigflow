...
- Introduce alternative CSS frameworks (Tailwind, Bootstrap, etc.)
...
- Bulma is the **only** general-purpose CSS framework
- Use Bulma for:
  - Layout
  - Forms
  - Buttons
...
- Override Bulma styles unnecessarily
- Mix Bulma with other utility or component frameworks
- Rebuild Bulma components manually
...
- Keep Svelte Flow styling separate from Bulma overrides
