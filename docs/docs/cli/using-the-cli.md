...
autogenerated [CLI reference](commands/zigflow).
...
[DSL reference](../dsl/intro) for the full schema.
...
This applies to every flag in the [CLI reference](commands/zigflow_run).
...
[CLI reference](commands/zigflow_run) for the default.
...
- [CLI reference](commands/zigflow) — full flag documentation
- [Quickstart](../getting-started/quickstart) — first workflow guide
- [Deployment overview](../deployment/intro) — production flags
